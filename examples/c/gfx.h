/*
 * gfx.h — tiny 2D shape-drawing helpers on top of the SDL3 renderer (C).
 *
 ...
 * under examples/cpp/ ships its own idiomatic copy (gfx.hpp); the two are
 * intentionally independent so either folder can be copied out and built on
 * its own, with no shared source and no cross-language linking.
 *
